...
contract CoinMED // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0xFbAbB7b67030e4BE471A095244898B651411b6A5; // @eachvar
    address public account_address = 0xFbAbB7b67030e4BE471A095244898B651411b6A5; // @eachvar 初始化后转入代币的地址
